...
\textcolor{blue}{Price} discrimination is not always harmful. When the most price-sensitive buyers, typically the lower-income, pay the lowest prices, it can broaden access and produce equity gains.\citep{varian1985pd} US healthcare runs in the other direction. Price tracks bargaining leverage, not elasticity. The people with the least leverage pay the highest prices.\citep{reinhardt2011allpayer, anderson2015allpayer} The uninsured face list prices.\citep{dusetzina2016uninsured, bai2015markup} Insured patients function as uninsured until they meet their deductible. Patients on specialty-drug coinsurance pay a percentage of list, not of the post-rebate net. Out-of-network and emergency patients face near-list rates. Cash payers using third-party discount tools sometimes pay less than their own insurance plan would charge. Small employers and small commercial insurers pay higher rates than large ones for the same care. The pattern is too consistent to be a failure at one tail. It is how the schedule operates, and hospital concentration deepens it where leverage is thin.\citep{cooper2019price} Price opacity keeps it out of view. Targeting the most visible group would leave the structure intact for everyone else caught in it. Reform 2 replaces this schedule with uniform \textcolor{green}{pricing} (see \href{https://rabbanimaysam.github.io/health-reform-proposal/faq.html}{FAQ \faqInvertedSchedule}).
