...
I present three interconnected reforms: consolidated government negotiation, Bloc-wide pricing as a condition of market access, and a central price lookup system. None is novel on its own; each has been proposed, studied, or partially implemented. The contribution of this note is to synthesize them into a coherent trio that closes the weaknesses of each component alone. A fuller discussion of what is incremental and what is novel, along with the relevant literature, is in the \href{https://rabbanimaysam.github.io/health-reform-proposal/faq.html\#novelty}{FAQ}.
...
Where transparency has been paired with the ability to compare providers, price reductions have followed; the \href{https://rabbanimaysam.github.io/health-reform-proposal/faq.html\#novelty}{FAQ} surveys the evidence.
